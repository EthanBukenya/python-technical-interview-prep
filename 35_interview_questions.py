...
# Problem Statement
# You are given an array of numbers and a target sum. Your task is to find the indices of the
...
# Instead of using a brute-force approach with two loops, we can solve this problem efficiently
